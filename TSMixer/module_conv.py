...
class PreNormResidual(nn.Module):
    """
    Pre-Normalization Residual Block. Applies Layer-Normalization before the residual connection over the features and
    prediction_length dimensions.
...
class TSMixerModel(nn.Module):
    ...
    def forward(
        ...
        nn_out_reshaped = rearrange(nn_out, "b ns nf h -> b h ns nf")
