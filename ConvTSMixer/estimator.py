...
from .lightning_module import ConvTSMixerLightningModule
...
class ConvTSMixerEstimator(PyTorchLightningEstimator):
    """
    ...
    def create_lightning_module(self) -> pl.LightningModule:
        return ConvTSMixerLightningModule(
            loss=self.loss,
            lr=self.lr,
    ...
    def _create_instance_splitter(self, module: ConvTSMixerLightningModule, mode: str):
    ...
    def create_training_data_loader(
        self,
        data: Dataset,
        module: ConvTSMixerLightningModule,
